...
using GuitarStore.Common.EFCore;
...
//builder.Services.AddPostgresDbContextConfiguration(builder.Configuration);
builder.Services.AddJwtConfiguration(builder.Configuration);
builder.Services.AddS3Configuration(builder.Configuration);
